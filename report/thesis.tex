...
TODO getting bored in meetings as main motivation.
...
Designers of CVEs can apply methods to manipulate social interaction.
These strategic manipulations may decouple the rendering of the avatars or the environment from the real interactants behaviour.
For example, the underlying physics of face-to-face conversation imply zero-sum gaze.
Meaning, that if interactant A is gazing at B 80\% of the conversation, they can't gaze at C for more than 20\% of the conversation.
...
Transformed social interaction (TSI) is a set of methods that system designers may apply to strategically manipulate the social interaction in CVEs \citep{Bailenson2004}.
...
An example, however, might be a system designed to support rewinding the interaction to view past conversations.

Many studies explored the effects of transforming self-representations in CVEs.
...
Put in the wrong hands, the ability to increase the persuasion capabilities might be frightening.
...
TODO \citep{Goodwin1979, Healey2009, Battersby2010}.
...
The design of the player avatar followed the following principles.
...
No correlation was found between VR expertise and detection performance nor with faking behaviours.
...
Otherwise, participants would detect faked behaviours immediately, causing the faking period length to have insignificant effect.
...
A platform to investigate automated behaviours.
